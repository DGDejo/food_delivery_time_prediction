...
Clone the repository: git clone https://github.com/DGDejo/food_delivery_time_prediction.git

Navigate to the API folder: cd food_delivery_time_prediction/model_pipeline/model
